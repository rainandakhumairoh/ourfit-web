          ...
          <div className="relative">
            <div className="space-y-6">
              ...
              <div className="text-center lg:text-center">
                <h1 className="text-3xl lg:text-4xl font-bold text-pink1 mb-3">
                  SIGN UP FOR AN ACCOUNT?
                </h1>
                <p className="text-sm lg:text-base text-[#8B5A4A]">
                  Buat akun dan nikmati pengalaman yang lebih personal, dari rekomendasi ukuran hingga gaya yang paling cocok untukmu.
                </p>
              </div>
              ...
              <p className="text-center text-sm text-coklat">
                Sudah punya akun?{" "}
                <a href="/login" className="text-pink1 font-semibold hover:underline">
                  Log in
                </a>
              </p>
            </div>
