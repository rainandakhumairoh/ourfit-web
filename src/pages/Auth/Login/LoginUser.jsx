        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 items-center">
          ...
          <div className="relative">
            ...
            <div className="space-y-6">
              ...
              <div className="text-center lg:text-center">
                ...
                <h1 className="text-4xl lg:text-5xl font-bold text-pink1 mb-3">
                  WELCOME BACK!
                </h1>

                <p className="text-sm lg:text-base text-[#8B5A4A]">
                  Masuk untuk melanjutkan perjalanan gaya personalmu
                  bersama Ourfit.
                </p>
              ...
              >
                ...
                <div className="text-right">
                  ...
                  <a
                    href="#"
                    className="text-sm text-pink1 hover:underline font-medium"
                  >
                    Forgot password?
                  </a>
              ...
              <div className="space-y-3">
                ...
                <p className="text-center text-sm text-[#8B5A4A] font-medium">
                  or log in with
                </p>
                ...
                <div className="flex justify-center gap-4">
                  ...
                  {/* GOOGLE */}
                  <button
                    className="w-10 h-10 rounded-full bg-white hover:bg-gray-100 transition flex items-center justify-center shadow-md"
              ...
              <p className="text-center text-sm text-coklat">
                ...
                <a
                  href="/register"
                  className="text-pink1 font-semibold hover:underline"
                >
                  Sign up
                </a>
          ...
          <div className="hidden lg:flex justify-center items-center">
            ...
            <img
              src={karakter}
              alt="Karakter Ourfit"
              className="w-[200px] md:w-[350px] lg:w-[400px] scale-110 md:scale-125 lg:scale-150 mb-6 transition-transform duration-300 ease-in-out"
            />
