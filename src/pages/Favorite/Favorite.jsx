  ...
  return (
    <div className="min-h-screen font-[Poppins] bg-coklat p-10 pt-28">
      <div className="max-w-6xl mx-auto">
        <button
          onClick={() => navigate(-1)}
          className="fixed top-24 left-8 bg-pink2 text-white p-3 rounded-full shadow-md hover:bg-oren2 transition z-50"
        >
          <ArrowLeft size={20} />
        </button>
        ...
        {!loading && favorite.length === 0 && (
          <div className="flex flex-col items-center justify-center py-20 text-center">
            ...
            <button
              ...
              className="mt-6 px-6 py-2 bg-pink2 text-white rounded-full text-sm font-medium hover:bg-oren2 transition-colors"
            >
              Jelajahi Produk
            </button>
          </div>
