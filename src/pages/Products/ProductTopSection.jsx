...
const SORT_OPTIONS = [
  { label: "Default", value: "default", icon: <ArrowUpDown size={13} /> },
  { label: "Harga Terendah", value: "price_asc", icon: <ArrowUp size={13} /> },
  { label: "Harga Tertinggi", value: "price_desc", icon: <ArrowDown size={13} /> },
  { label: "Nama A–Z", value: "name_asc", icon: <ArrowUpDown size={13} /> },
  { label: "Nama Z–A", value: "name_desc", icon: <ArrowUpDown size={13} /> },
];
      ...
      <div className="bg-primary pt-24 pb-5 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-wrap items-center justify-between gap-3">
            ...
            {/* SORT DROPDOWN */}
            <SortDropdown sortValue={currentSort} onChange={handleSortChange} />
            ...
            <div className="flex-1 max-w-md relative">
              <input
                ...
                onKeyDown={(e) => {
                  // Bisa tambahkan logika onEnter di sini jika perlu
                }}
            ...
            <button
              ...
              title={!currentUser ? "Login untuk melihat produk favorit" : "Lihat favorit saya"}
              className="flex items-center gap-1 px-4 py-1 rounded-full text-sm font-medium bg-white text-pink1 hover:bg-pink1 hover:text-white transition-colors shadow-sm ml-2"
            >
              <Heart size={14} />
              Favorite
            </button>
