        ...
        {alreadyPersonalized ? (
          <>
            <p className="text-coklat text-sm max-w-[350px] mt-3">
              Kamu sudah pernah melakukan personalisasi.
            </p>

            <button
              onClick={() => navigate("/profile")}
              className="w-[350px] py-2 mt-8 bg-pink1 hover:bg-oren2 text-white  rounded-full text-lg font-medium  shadow-sm transition"
            >
              Lihat Hasil Saya
            </button>
            ...
            <button
              ...
              className="w-[350px] py-2 mt-4 text-white bg-coklat hover:bg-oren3 rounded-full text-lg font-medium shadow-sm transition"
            >
              Personalisasi Ulang
            </button>
          </>
